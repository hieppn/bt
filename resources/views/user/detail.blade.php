...
      <div class="tab-pane active" id="pic-1"> <img src="{{'/storage/'.$product->image }}" width="500px" height="500px" style="margin-left:200px;">
      </div> 
     </div> 
    </div> 
...
 <h4 class="price">Giá cũ: <span style="text-decoration: line-through;color:blue;">{{$product->oldprice}}.vnđ</span></h4> 
