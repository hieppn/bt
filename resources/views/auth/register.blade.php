...
@endif
  ...
  <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
    ...
    <input type="number" class="form-control"required   placeholder="Enter phone" name="phone">
  </div>
  ...
  <div class="form-group{{ $errors->has('money') ? ' has-error' : '' }}">
    <label for="money">Nạp tiền<small style="color: blue;">(Có thể không nạp)</small>:</label>
    <input type="number" class="form-control"required   placeholder="Not requiment" name="money" value="0">
  </div>
